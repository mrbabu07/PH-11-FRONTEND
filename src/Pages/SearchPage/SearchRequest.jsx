...
//         `https://ph-11-backend-mocha.vercel.app/donation-request?${params.toString()}`
//       );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-rose-50 to-orange-50 p-4 py-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-20 left-10 w-72 h-72 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Search for available blood donation requests in your area
          </p>
        </div>
        ...
        <form
          ...
          className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl mb-8 border border-red-100"
        >
              ...
              >
                ...
                {upazilas
                  .filter(
                    (u) =>
                      u.district_id ===
                      districts.find((d) => d.name === district)?.id
                  )
                  .map((u) => (
